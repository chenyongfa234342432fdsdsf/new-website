import { AllCurrenciesList, LiveRateItemList, WalletBalance } from '@/typings/api/asset'

/** 用户资产相关列表 */
export const getWalletBalanceRequest = (): Promise<WalletBalance> => {
...
/** 相关币种兑换列表 */
export const getLiveRateItemListRequest = (): Promise<LiveRateItemList> => {
  return new Promise(resolve => {
    resolve({
      ok: true,
      warning: '',
...
/** 所有币种详情列表 */
export const getAllCurrenciesRequest = (): Promise<AllCurrenciesList> => {
  return new Promise(resolve => {
    resolve({
      currencies: [
        {
